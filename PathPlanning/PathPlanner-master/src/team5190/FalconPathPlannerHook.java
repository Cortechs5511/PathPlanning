...
public class FalconPathPlannerHook {
	...
	public FalconPathPlannerHook(ArrayList<DPoint> waypoints, double totalTime, double timeStep, double robotTrackWidth) {
	...
	public String[][] extraData(){
		return new String[][] {
			{"Path Alpha",path.pathAlpha+""},
			{"Path Points",path.numFinalPoints+""},
			{"Path Beta",path.pathBeta+""},
			{"Path Tolerance",path.pathTolerance+""},
			{"Path Distance",path.totalDistance+""},
			{"Path Time",path.totalTime+""},
			{"Path Velocity Alpha",path.velocityAlpha+""},
			{"Path Velocity Beta",path.velocityBeta+""},
			{"Path Velocity Tolerance",path.velocityTolerance+""}
		};
	}
