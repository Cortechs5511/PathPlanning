...
public class FalconPathPlanner {
	...
	public static void print(double[] path) {
		System.out.println("Left Velocity: \t Right Velocity: 100ms per line");
	 ...
	 * @param path
	 */
	public static void print(double[][] path, double[][] path2) {
		System.out.println("X: \t Y:");

		for (int index = 0; index < path.length; index++) {
			double[] leftPathData = path[index];
			double[] rightPathData = path2[index];
			System.out.println(leftPathData[1] + "\t" + rightPathData[1]);
