...
public class Window extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					Font headerFont = new Font("Yu Gothic UI Light", Font.PLAIN, 17);
					Font normalFont = new Font("Yu Gothic UI", Font.PLAIN, 13);
					UIManager.put("Label.font", headerFont);
					UIManager.put("Button.font", normalFont);
					for(Object property : UIManager.getLookAndFeelDefaults().keySet()){
	 ...
	 */
	public Window() {
		setTitle("5190 Path Maker v1.1 - credit to team 2168 for path calculations");
